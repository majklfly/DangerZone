  ...
  return (
    <div className="containerTerms">
      <span key={0}>
        ...
        <br />
        <h4>Last updated 04/26/2020</h4>
        <br />
        <p>
          Thank you for choosing to be part of our community at DangerZone
          e-learning (“Company”, “we”, “us”, or “our”). We are committed to
        ...
        <br />
        <p>
          When you visit our website http://dangerzone-react.herokuapp.com/,
          ...
          notice that you do not agree with, please discontinue use of our Sites
          or Apps and our services.
        </p>
        <br />
        <p>
          This privacy notice applies to all information collected through our
          website (such as http://dangerzone-react.herokuapp.com/), mobile
          application, ("Apps"), and/or any related services, sales, marketing
          or events (we refer to them collectively in this privacy notice as the
          "Services").
        </p>
        <br />
        <p>
        ...
        <br />
        <p>
          In Short: We may collect information regarding your push
        ...
        <p>
          ...
          to facilitate account creation and logon process for the performance
          of the contract. See the section below headed "HOW DO WE HANDLE YOUR
        ...
        <p>
          ...
          necessary to achieve our legitimate business interests. Performance of
          a Contract: Where we have entered into a contract with you, we may
          process your personal information to fulfill the terms of our
          contract. Legal Obligations: We may disclose your information where we
        ...
        <p>
          ...
          personal information in the following situations: Vendors, Consultants
          and Other Third-Party Service Providers. We may share your data with
          ...
          technology on the Services or Apps, which will enable them to collect
          data about how you interact with the Services or Apps over time. This
          ...
          all or a portion of our business to another company. Third-Party
          Advertisers. We may use third-party advertising companies to serve ads
          when you visit the Services or Apps. These companies may use
        ...
        <p>
          ...
          18, please contact us at majklfly@gmail.com.
        </p>
        <br />
        ...
        <p>
          ...
          email us at majklfly@gmail.com.
        </p>
        ...
        <p>
          ...
          requirements. Opting out of email marketing: You can unsubscribe from
        ...
        <p>
          ...
          account with the Services or Apps, you have the right to request
        ...
        <p>
          ...
          at majklfly@gmail.com or by post to: DangerZone e-learning Munster
          Road 66 Banfield House London SW6 4EX United Kingdom
        </p>
        <br />
        <h2>
        ...
        <p>
          ...
          http://dangerzone-react.herokuapp.com/profile/. We will respond to
